...
const ForgetPassword = ({ email,SetEmail,loginPopUp, SetloginPopUp, SetforgetPopUp,Otpvarification,SetOtpvarification,SetconfirmPopUP }) => {
...
//   const [Otpvarification, SetOtpvarification] = useState(false);
  ...
  const OnVarify = async () => {
    ...
    try {
      const response = await axios.post(`${url}/api/delBoy/verifyOtp`, { email, otp: OTP });
  ...
  return (
    <div className='ForgetPopUp'>
        ...
        <div className="login-popup-title">
          ...
          <img
            onClick={() => {SetforgetPopUp(false),SetloginPopUp(true)}}
