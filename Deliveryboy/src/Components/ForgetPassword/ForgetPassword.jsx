      ...
      <div className="ForgetPopUp-container">
        ...
        {Otpvarification ? (
          <button className="card-button" onClick={OnVarify}>
           {loading==true ?<div style={{display: "flex", alignItems: "center", justifyContent: "center",backgroundColor:"black",border:"0px solid white"}}><Loader /></div> : "Varify OTP"}
          </button>
        ) : (
          <button className="card-button" onClick={OnSubmit}>
              {loading==true ?<div style={{display: "flex", alignItems: "center", justifyContent: "center",backgroundColor:"black",border:"0px solid white"}}><Loader /></div> :"Send OTP" }
          </button>
        )}
      </div>
    </div>
