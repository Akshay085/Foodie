        ...
        <div className="ForgetPopUp">
            <div className="ForgetPopUp-container">
                <div className="login-popup-title">
                    ...
                    <img onClick={() => SetForget(false)} src="/Images/cross_icon.png" alt="Close" />
                </div>
                <form onSubmit={OnSubmit}> {/* Wrap in form and add onSubmit */}
                    ...
                    {Otpvarification ? (
                        <input type="text" placeholder="Enter OTP" name="OTP" value={OTP} onChange={handleChange} className="card-input" />
                    ) : (
